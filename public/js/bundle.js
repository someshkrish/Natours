...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic29tZXNoMDAxIiwiYSI6ImNrcDVham9seTA5N20ybnBldXdmNHhqMmQifQ.iAbQ4AcmH6N4yVzAGKl2xw';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // Refreshes and redirects to the home page
...
var stripe = Stripe('pk_test_51Ix4CfSDpGTkb8b3OrcWEMKR4IuDH9AHStUbcf9tIELjq2SQFALC2PhsizufYWTKuxzKG2fo4gBFC9iyvgB7TukI00oHlxT2id'); //Public key for front end.
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get('http://127.0.0.1:3000/api/v1/bookings/checkout-session', {
              params: {
                tourId: tourId
              }
            });
...
var bookingBtn = document.getElementById('book-tour'); //VALUES
